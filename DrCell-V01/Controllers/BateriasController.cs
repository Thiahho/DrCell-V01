...
namespace DrCell_V01.Controllers
{
    ...
    public class BateriasController : ControllerBase
    {
        ...
        private readonly ILogger<BateriasController> _logger;
        
        public BateriasController(ApplicationDbContext context, IBateriasService bateriasService, ILogger<BateriasController> logger)
        {
            _context = context;
